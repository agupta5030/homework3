        ...
        if transform_pipeline == "default":
            ...
            xform = transforms.Compose(
                [
                    ...
                    # Randomly flip images left-right with 50% probability
                    transforms.RandomHorizontalFlip(p=0.5),
                    
                    # Randomly adjust color properties to simulate different lighting
                    transforms.ColorJitter(
                        brightness=0.3,  # Vary brightness
                        contrast=0.3,    # Vary contrast
                        saturation=0.2,  # Vary color intensity
                        hue=0.05         # Slightly vary hue (reduced to avoid overflow)
                    ),            
